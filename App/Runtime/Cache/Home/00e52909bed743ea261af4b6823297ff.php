...
<html>
	...
	<body>
		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
			<a href="/house/index.php/Index/location" id='setting' class=" mui-pull-left mui-btn-link"><?php echo session('location') ?session('location'):'北京' ;?></a>
			<span class="mui-icon mui-icon-arrowdown" onclick="javascript:;window.location='/house/index.php/Index/location' "></span>
		...
		<div id="slider" class="mui-slider" >
			<div class="mui-slider-group mui-slider-loop">
				...
				<div class="mui-slider-item mui-slider-item-duplicate">
					<a href="<?php echo ($slider["0"]["link"]); ?>">
						<img src="/house/Public/<?php echo ($slider["0"]["img"]); ?>">
			...
			<?php if(is_array($slider)): $i = 0; $__LIST__ = $slider;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="mui-slider-item">
					<a href="<?php echo ($vo["link"]); ?>">
						<img src="/house/Public/<?php echo ($vo["img"]); ?>">
    ...
    <div class="mui-row" style="background-color:white;margin-bottom:0.2%;">
        <div class="mui-col-sm-4 mui-col-xs-4">
            <li class="mui-table-view-cell">
                <a class="mui-navigate-right" href="/house/index.php/House/lists">
                    整租
                </a>
            </li>
        </div>
        ...
        <div class="mui-col-sm-4 mui-col-xs-4">
            <li class="mui-table-view-cell">
                <a class="mui-navigate-right" href="/house/index.php/Message">
                    消息
                </a>
            </li>
        </div> 
        <div class="mui-col-sm-4 mui-col-xs-4">
            <li class="mui-table-view-cell">
                <a class="mui-navigate-right" href="/house/index.php/User">
                    我的
                </a>
            </li>
        </div> 
