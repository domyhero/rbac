...
<form action="/bool/admin.php/Slider/edit/id/1" method="post" enctype="multipart/form-data">
	<table class="table table-hover table-bordered table-condensed table-responsive" >
		<tr class="info" style="text-align:center;">
			<td colspan="3">
				添加轮播
				<span style="float:right;"> [ <a href="/bool/admin.php/Slider/index">列表</a> ] </span>
			</td>
		</tr>
		<input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
		<tr>
			<td>轮播图片</td> 
			<td><input type="file" name="img">   /bool/Public/<?php echo ($info["img"]); ?>  </td>
			<td rowspan="6" width="120px" style="text-align:center;">
				<img src="/bool/Public/<?php echo ($info["img"]); ?>" alt="" class="img-thumbnail">
			</td>
		</tr>
