...
<link rel="stylesheet" type="text/css" href="/bool/Public/Admin/css/login.css" />
<style>
	.verify{
		width:120px;
		cursor:pointer;
...
<body id="loginpage">
	<div id="login" class="clearfix">
		<div class="main clearfix">
			<div class="logbox">
				<div class="header">
					<img alt="布尔后台系统" title="布尔后台系统" src="/bool/Public/Admin/images/logo/syslogo.png" height="40" width="263">
				</div>
				<div class="web_login" id="web_login">
					<form id="loginform"  name="loginform" action="/bool/admin.php/Login/login" method="post" target="_self">
                        ...
                        <div class="inputOuter">
                            ...
                            <img src="/bool/admin.php/Login/verify" alt="点击更换验证码" onclick="this.src='/bool/admin.php/Login/verify/'+Math.random " class="verify">
                        </div>
...
<script src="/bool/Public/Admin/js/jquery.min.js"></script>