...
<form action="/bool/admin.php/Config/index" method="post" enctype="multipart/form-data">
	<table class="table table-hover table-bordered table-condensed table-responsive" >
		...
		<tr>
			<td>网站Logo</td> 
			<td>
				<input type="file" name="img"> /bool/Public/<?php echo ($info["logo"]); ?>
			</td>
			<td rowspan="3" width="120px" style="text-align:center;">
				<a href="">
					<img src="/bool/Public/<?php echo ($info["logo"]); ?>" alt="" class="img-thumbnail">
				</a>
				<span>Logo</span>
			</td>
		</tr>
